...
#pragma compile(FileVersion, 5.1)
...
$sBotVersion = "v5.1" ;~ Don't add more here, but below. Version can't be longer than vX.y.z because it it also use on Checkversion()
