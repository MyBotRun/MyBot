	...
	While 1
		...
		For $i = 0 To UBound($g_avAttackTroops) - 1
			If $g_avAttackTroops[$i][0] = $eBarb Then
				$iBarb = $i
			ElseIf $g_avAttackTroops[$i][0] = $eArch Then
				$iArch = $i
			ElseIf $g_avAttackTroops[$i][0] = $eCastle Or $g_avAttackTroops[$i][0] = $eWallW Or $g_avAttackTroops[$i][0] = $eBattleB Then
				$iCC = $i
		...
		$g_iSidesAttack = $g_aiAttackStdDropSides[$g_iMatchMode] + 2
