...
Func THSearch($bReTest = False)
	...
	$result = DllCall($pFuncLib, "str", "getLocationTownHallWithLevel", "ptr", $hBitmapFirst)
	;$result = DllCall($pFuncLib, "str", "getLocationTownHallWithLevelDebug", "ptr", $hBitmapFirst, "int", 1)
