...
Global $aGlobalTab[2]        = [ 63,  24]               ; Global Tab, Chat Window, Main Screen
Global $aGlobalChatBox[2]    = [ 63,  55]               ; Textbox, Global Tab, Chat Window, Main Screen
Global $aGlobalChatSend[2]   = [282,  55]               ; Send Button, Global Tab, Chat Window, Main Screen
