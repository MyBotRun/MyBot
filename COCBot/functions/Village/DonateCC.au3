...
Func DonateCC($Check = False)
	...
	While $Donate
;		$debugOcr = 1 ;Noyax remove by instruction of @ezeck0001 https://mybot.run/forums/thread-13974.html
		...
		If IsArray($Scroll) Then
			...
			ContinueLoop
		EndIf
;		$debugOcr = 0 ;Noyax remove by instruction of @ezeck0001 https://mybot.run/forums/thread-13974.html
		$Donate = False
	WEnd
