...
$tabDonate = GUICtrlCreateTabItem(GetTranslated(6,1, "Donate"))
	Local $x = 30, $y = 150
	$grpDonation = GUICtrlCreateGroup(GetTranslated(6,2, "Ask for Clan Castle Troops"), $x - 20, $y - 20, 450, 65)
		...
		$txtRequest = GUICtrlCreateInput(GetTranslated(6,4, "Anything please"), $x + 115, $y + 5, 305, -1)
...
$x -=2
	...
	$lblBtnCustom = GUICtrlCreateLabel("", $x + 363, $y + 8 , 42, 42)
		GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
		GUICtrlSetState(-1, $GUI_DISABLE)
	$btnCustom = GUICtrlCreateButton("", $x + 365, $y + 10 , 38, 38, $BS_ICON)
...
$y += 40
	...
	;;; Extra Alphabets
	$chkExtraAlphabets = GUICtrlCreateCheckbox(GetTranslated(6,25, "Cyrillic"), $x + 363, $y + 15 , -1, -1)
