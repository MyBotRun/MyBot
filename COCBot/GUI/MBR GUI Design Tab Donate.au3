...
$x -=2
	...
	$lblBtnCustom = GUICtrlCreateLabel("", $x + 363, $y + 8 , 42, 42)
		GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
		GUICtrlSetState(-1, $GUI_DISABLE)
	$btnCustom = GUICtrlCreateButton("Custom", $x + 365, $y + 10 , 38, 38, $BS_ICON)
...
$y += 40
	...
	;;; Extra Alphabets
	$chkExtraAlphabets = GUICtrlCreateCheckbox("Cyrillic", $x + 363, $y + 15 , -1, -1)
		GUICtrlSetTip(-1, "Check this to enable Cyrillic Alphabets")
