...
$tabNotify = GUICtrlCreateTabItem("Notify")
	...
	$chkPBenabled = GUICtrlCreateCheckbox("Enable pushbullet", $x + 40, $y - 10 )
	...
	$y += 25
	$lblOrigPush = GUICtrlCreateLabel("Profile/Village Name:", $x + 220 , $y +25, -1, -1 , $SS_RIGHT)
	...
	$chkAlertPBOtherDevice = GUICtrlCreateCheckbox("Another device connected", $x + 210, $y, -1, -1)
		...
		GUICtrlSetState(-1, $GUI_DISABLE)
	$y = 350
	$lblgrppushbullet = GUICtrlCreateGroup("PushBullet Remote Control Functions", $x - 10, $y - 15, 430, 170)
