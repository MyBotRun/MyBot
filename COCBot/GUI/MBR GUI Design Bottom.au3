...
;~ Buttons
Local $x = 15, $y = 525
$grpButtons = GUICtrlCreateGroup("https://mybot.run " & GetTranslated(602,0, "- freeware bot -"), $x - 5, $y - 10, 190, 85)
	...
	$btnHide = GUICtrlCreateButton(GetTranslated(602,11, "Hide"), $x + 40, $y + 45, 50, -1)
		...
		GUICtrlSetState(-1, $GUI_DISABLE)
	$chkBackground = GUICtrlCreateCheckbox(GetTranslated(602,14, "Background") & @CRLF & GetTranslated(602,15, "Mode"), $x + 100, $y + 46, 70, 24, BITOR($BS_MULTILINE, $BS_CENTER))
