...
;			GUICtrlSetFont(-1, 8)
		...
		$txtUpgradeValue[$i] = GUICtrlCreateInput("", $x+205, $y, 69, 17, BitOR($ES_CENTER, $GUI_SS_DEFAULT_INPUT, $ES_READONLY, $ES_NUMBER))
;			GUICtrlSetFont(-1, 8)
			GUICtrlSetTip(-1, $sTxtShowCost)
		$txtUpgradeTime[$i] = GUICtrlCreateInput("", $x+277, $y, 36, 17, BitOR($ES_CENTER, $GUI_SS_DEFAULT_INPUT, $ES_READONLY, $ES_NUMBER))
;			GUICtrlSetFont(-1, 8)
